...
if os.getenv("SIBYL_KEY", "1822863941:1Y0cxeaz0AV4O1dRP9nWOEmhn1pbNFhusj8gev8r2dkgG8WkGfI0ikfFmp8fpi-g"):
    SIBYL_KEY = os.getenv("1822863941:1Y0cxeaz0AV4O1dRP9nWOEmhn1pbNFhusj8gev8r2dkgG8WkGfI0ikfFmp8fpi-g")
else:
    try:
        from configparser import ConfigParser
        p = ConfigParser()
        p.read("config.ini")
        SIBYL_KEY = p.get("kigconfig", "1822863941:1Y0cxeaz0AV4O1dRP9nWOEmhn1pbNFhusj8gev8r2dkgG8WkGfI0ikfFmp8fpi-g")
    except:
        try:
...
if SIBYL_KEY and __name__.split(".")[-1] in ALL_MODULES:
    try:
        sibylClient = PsychoPass("1822863941:1Y0cxeaz0AV4O1dRP9nWOEmhn1pbNFhusj8gev8r2dkgG8WkGfI0ikfFmp8fpi-g")
